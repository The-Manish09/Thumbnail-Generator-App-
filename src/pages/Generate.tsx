              ...
              <div className="p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6">
                <div>
                  ...
                  <p className="text-sm text-zinc-400">
                    Describe your vision and left AI bring it to life
                  </p>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      maxLength={100}
                      placeholder="e.g.,10 Tip for Better Sleep"
                ...
                {/* button */}
                {!id && (
                  <button className="text-[15px] w-full py-3.5 rounded-xl font-medium bg-linear-to-b form-pink-500 to-pink-600 hover:from-pink-700 disabled:cursor-not-allowed transition-colors">
